                    ...
                    <section class="panel">
                        <div class="panel-body transferlist">
                            <div class="table-responsive">
                                제목 : <input type="text" name="title" value="${faqVo.title}" readonly>
                                조회수 : <input type="text" value="${faqVo.hit}" readonly>
                                <br>
                                <br>
                                내용 : <br>
                                <textarea name="content" id="" readonly>${faqVo.content}</textarea>
                            </div>
